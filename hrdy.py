...
db   db d8888b. d888888b d8888b.  .d8b.  db    db      
88   88 88  `8D   `88'   88  `8D d8' `8b `8b  d8'      
88ooo88 88oobY'    88    88   88 88ooo88  `8bd8'       
88~~~88 88`8b      88    88   88 88~~~88    88         
88   88 88 `88.   .88.   88  .8D 88   88    88         
YP   YP 88   YD Y888888P Y8888D' YP   YP    YP         
...
def main():
        ...
        if menu_opt =='1':
                ...
                if menu_opt =='1':
                        ...
                        print('first12345')
                        print('i love you')
                        print('firstChaudhary')
                        print('ChaudharyChaudhary')
                        print('Chaudhary12345')
                        print('Chaudhary12')
                        print('first786')
                        input('\nPress enter to back ')
                        main()
